...
public class Main2Activity extends AppCompatActivity {
    ...
    //String[] about_imam;
    int img[]={R.drawable.ali,R.drawable.hasn,R.drawable.hus,R.drawable.sa,R.drawable.baq,R.drawable.sadeq,R.drawable.ka,R.drawable.reza,R.drawable.jawad,R.drawable.hadi,R.drawable.ask,R.drawable.mahdi};
    int position;
   String[] about_imam={"سسس",
           "اسمه: الحسن.\n" +
                   "\n" +
                   ...
                   "\n" +
                   "وفاته: استشهد مسموما على يد زوجته جعدة في7 صفر سنة سنة49 وله من العمر سبع وأربعون سنة.\n" +
                   "\n" +
           ...
           "ولادتـه (عليه السلام): ولد (عليه السلام) بالمدينة في الثالث من شهر شعبان على المشهور في السنة الرابعة للهجرة(1).وروي أنّ النبي الأكرم (صلّى الله عليه و آله) صلّى الظهر يوماً رأى جبرئيل (عليه السلام) فقال: «الله أكبر» فأخبره جبرئيل برجوع جعفر من أرض الحبشة فكبّر ثانياً فجاءت البشارة بولادة الحسين (عليه السلام) فكبّر ثالثاً(2).\n" +           "\n" +
   ...
   "اسمه: موسى.\n" +
           ...
           "اسمه: الإمام التاسع محمد.\n" +
                   ...
                   "\n" +
                   "وانتقل الإمام غلى جنة المأوى فقام ابنه الإمام علي الهادي بإجراء مراسم الوفاة عليه وحفر له قبرا ملاصقا إلى قبر جده الكاظم (عليه السلام).\n" +
                   "\n" +
   ...
   "اسمه: محمد.\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2);
            ...
            String imam_ali = getResources().getString(R.string.imam_ali);
            String imam_hasan = getResources().getString(R.string.imam_hassan);
            String imam_hussien = getResources().getString(R.string.imam_hussien);
            String imam_zain = getResources().getString(R.string.imam_zain);
            String imam_baker = getResources().getString(R.string.imam_baqer);
            String imam_sadek = getResources().getString(R.string.imam_sadek);
            String imam_kazem = getResources().getString(R.string.imam_kazem);
            String imam_reza = getResources().getString(R.string.imam_reza);
            String imam_jawad = getResources().getString(R.string.imam_jawad);
            String imam_hadi = getResources().getString(R.string.imam_hadi);
            String imam_askri = getResources().getString(R.string.imam_askri);
            String imam_mahdi = getResources().getString(R.string.imam_mahdi);
...
ArrayList<String > z=new ArrayList<String >();
        ...
        rank = i.getStringArrayExtra("rank");
            ...
            Typeface typeface=Typeface.createFromAsset(getAssets(),"fo1.ttf");
        ...
        textView.setText(z.get(position));
            textView.setTypeface(typeface);
     //   textView.setMovementMethod(new ScrollingMovementMethod());


        //img=i.getExtras().getInt("img");

        tex = (TextView) findViewById(R.id.name);
        tex.setText(rank[position]);
